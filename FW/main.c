...
void main(void)
{
    ...
    LED = 1;             // The orange led is turned off from the callback function "RxJoinResponse" indicating the LoRaWAN stack was initialized properly
...
void IO_pins_init(void){
    ...
    TRISCbits.TRISC3 = 1;       // Temperature sensor
